...
<center><button id='bloquer'      class="bloc-btn btn btn-warning" style="display:none;color:black;margin-bottom:15px"><i class="fas fa-comment-slash"></i>  Bannir</button></center>
<?php } ?>
